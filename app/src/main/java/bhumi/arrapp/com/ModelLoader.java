...
public class ModelLoader {
    private final WeakReference<MainArFragmentActivity> owner;
    private static final String TAG = "ModelLoader";

    ModelLoader(WeakReference<MainArFragmentActivity> owner) {
        this.owner = owner;
    }
    ...
    void loadModel(Anchor anchor, Uri uri) {
        ...
        ModelRenderable.builder()
                ...
                .handle((renderable, throwable) -> {
                    MainArFragmentActivity activity = owner.get();
                    if (activity == null) {
                        return null;
                    } else if (throwable != null) activity.onException(throwable);
                    else {
